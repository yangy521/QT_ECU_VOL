...
#include "UserStackerTruckProcJiaLiGA.h"
#include "ErrCode.h"
#include "Eeprom.h"
#include "IQmathLib.h"
#include "PropProc.h"
...
//		Noflag = 0;
	...
	if ((0 == sgSwiInput.b1SafeLock)&&(0 == sgSwiInput.b1Slow_Mode))
	{
		SendData->b1ServoOn = 0;
	}
	
	if((1 == sgSwiInput.b1ChargeLimitAct)||(receivedId112Message == 1))
	{
...
/************  锂电协议*******************/	
	{
		...
		if(sgUserInfo.u8BatteryType == 0)
		{
			gCanSendPdoInfo.CanSend260Info.u8Soc = CanRev444InfoLast.BMS_SOC;
		}
		else if(sgUserInfo.u8BatteryType == 1)
		{
...
/************* LIFT DOWN****************/
		if((0 == LIFT_FLAG)&&(0 == HANDLE_FLAG)&&(0 == MOVE_FLAG))
		{
				...
				)
			{
			 ...
			 u8PumpOrPropValue = (255*(i32AdcValue-2800))/(4900-2800);
			}
			else if((i32AdcValue > 20) && (i32AdcValue < 2200))					  //2800 4900
			{
				LR_FLAG = 1;
				i32DoPwmSet(LIFTUP_VALVE,DRIVER_CLOSE);
				sgSwiInput.b1LiftDown = 1;
				sgSwiInput.b1LiftUp = 0;
				u16Prop = (65535*(2200-i32AdcValue))/(2200-20);
				i32PropValue = _IQ((sgUserInfo.fPropMinCurrent + (sgUserInfo.fPropMaxCurrent - sgUserInfo.fPropMinCurrent) * u16Prop / PUMP_RANGE) / PROPD_STD_CURRENT);
...
/******************* 前后移调速 ****************/
	...
	if((0 == LIFT_FLAG)&&(0 == HANDLE_FLAG)&&(0 == LR_FLAG))
	{
		...
		if((i32AdcValue < 2200)&&(i32AdcValue > 20))
		{
			MOVE_FLAG = 1;
			i32DoPwmSet(QIANYI_VALVE,DRIVER_OPEN);
			u8PumpOrPropValue = (255*(2200-i32AdcValue))/(2200-20);
		}
		else if((i32AdcValue > 2800) && (i32AdcValue < 5000)&&(0 == LIFT_FLAG)&&(0 == HANDLE_FLAG))
		{
			MOVE_FLAG = 1;
			i32DoPwmSet(HOUYI_VALVE,DRIVER_OPEN);
			u8PumpOrPropValue = (255*(i32AdcValue-2800))/(5000-2800);
		}
		else
		{
			MOVE_FLAG = 0;
...
//		i32AdcValue = i32LocalAiGetValue(LR_MOVE_THROTTLE);
		...
		else if((i32AdcValue > 2800) && (i32AdcValue < 5000)&&(0 == MOVE_FLAG)&&(0 == HANDLE_FLAG))
		{
			LIFT_FLAG = 1;
...
/******************手柄报文控制前后倾*******************************/
	...
	if((0 == MOVE_FLAG)&&(0 == LIFT_FLAG)&&(0 == LR_FLAG))
	{
		...
		else if((1 == gCanRevPdoInfo.CanRevInfo22C.b1Hypsokinesis)&&(0 == MOVE_FLAG)&&(0 == LIFT_FLAG))      //后倾
		{
			HANDLE_FLAG = 1;
			u8PumpOrPropValue = 125;
			i32DoPwmSet(HOUYANG_VALVE,DRIVER_OPEN);
		}
		else
		{
			HANDLE_FLAG = 0;
...
/**************长按龟速按钮进入直立行走状态**************/
	...
	if((1 == sgSwiInput.b1Pedal)&&(1 == sgSwiInput.b1Fence2))
	{
	...
	else if((1 == sgSwiInput.b1Pedal)&&(0 == sgSwiInput.b1Fence2))
	{
	...
	else if((0 == sgSwiInput.b1Pedal)&&(1 == sgSwiInput.b1Fence2))
	{
	...
	if((gCanSendPdoInfo.CanSend260Info.u8Soc <= 10))
	{
