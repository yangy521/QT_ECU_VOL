...
#if (USER_TYPE == USER_LIUGONG_2IN1_LOGIC)
/*参数配置部分*/
...
{	
	...
	vErrCodeInit(sgErrCodeInfo,200);
...
//							/*Swi*/
		i32SetPara(PARA_PcuKeyInfo,sgPcuInfo.u8data);									/*ErrCode*/
