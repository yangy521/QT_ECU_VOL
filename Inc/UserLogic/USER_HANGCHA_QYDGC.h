...
* Revision:	 														 		   *
*******************************************************************************/
#ifndef _USER_STACKER_TRUCK_PROC_HANGCHAQYDGC_H_
#define _USER_STACKER_TRUCK_PROC_HANGCHAQYDGC_H_
...
#define DIDI_VAKVE				DRIVER6

#define HouYi_VALVE				DRIVER4
#define QianYi_VALVE			DRIVER5

#define QianQin_VALVE			DRIVER7
#define HouQin_VALVE			DRIVER8

#define ZuoYi_VALVE				DRIVER9
#define YouYi_VALVE				DRIVER10

#define	LIFTDOWN_VALVE		PropDriverCh1

#define	HEIGHT_SPEEDLIMIT1_SWI				SWI1_R
#define	EmergencyReverse							SWI2_R
#define	SAFELOCK_SWI									SWI3_R
#define FENCE_SWI											SWI4_R
#define QianYiLimit_SWI								SWI5_R
#define	Pedal_SWI											SWI7_R
#define	Human_SWI								  		SWI6_R
