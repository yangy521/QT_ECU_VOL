...
#define Ems_ERR					(1 << 0)
#define Safelock_ERR		(1 << 1)
#define ForWard_ERR			(1 << 2)
#define Lift_ERR				(1 << 3)
#define NO_MOVE					(1 << 4)
#define NO_LIFT					(1 << 5)
...
#define Emergency_SWI							SWI2_R
#define	SAFELOCK_SWI							SWI3_R
#define ForWard_SWI								SWI4_R
#define BackWard_SWI							SWI5_R
#define StreeLimitSpeed_SWI				SWI6_R
#define	LIFT_LIMT_SWI							SWI7_R
#define DianBackWard_SWI					DRIVER7_R
#define LiftUp_SWI								DRIVER8_R
