...
//#define	LIFTUP_VALVE			DRIVER4
//#define	LEAN_FORWARD_VALVE		DRIVER3
#define	LEAN_BACKWARD_VALVE		DRIVER6
...
#define	PEDAL_CLOSE_SWI			DRIVER5_R
...
#define	ACT_FAULT_LOCK_ERR			ErrCode103
#define	MOVE_EMS_ERR				ErrCode104
#define	BAT_LOW_2_ERR				ErrCode106
#define	BAT_LOW_1_ERR				ErrCode107
...
//试验台测试
#endif //#if (USER_TYPE == USER_ZHONGLI_DGC)
