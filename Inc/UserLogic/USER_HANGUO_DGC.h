...
* Revision:	 														 		   *
*******************************************************************************/
#ifndef _USER_HANGUO_JINJIDAO_DGC_H_
#define _USER_HANGUO_JINJIDAO_DGC_H_
...
#define FRONT_VALVE								DRIVER4
#define BACK_VALVE								DRIVER5
#define DIDI_VALVE								DRIVER6
#define QianQin_VALVE							DRIVER9
#define HOUQin_VALVE							DRIVER10
#endif

#define BackWard_VALVE						DRIVER6
#define Direction_VALVE					DRIVER5

#ifdef JINJIDAO_DGC_IO_TYPE
#endif

#define LIFTDOWN_VALVE						PropDriverCh0
#define WARING_VALVE							PropDriverCh1
		
/*Move*/
#define BRAKE_SWI									SWI1_R
#define BELLYEms_SWI							SWI2_R
#define	SAFELOCK_SWI							SWI3_R
#define FORWARD_SWI								SWI4_R
#define BACKWARD_SWI							SWI5_R
#define TURTLE_SWI								SWI6_R
#define LIFTUP_SWI								SWI7_R
#define LIFTDOWN_SWI							SWI8_R

#ifdef JINJIDAO_DGC_IO_TYPE
#define QIANHOUQIN_SWI						DRIVER9_R
#define QIANHOUYI_SWI							DRIVER10_R
#endif

#define	MODE_SWI									DRIVER7_R
#define PUMPEN_SWI								DRIVER8_R
