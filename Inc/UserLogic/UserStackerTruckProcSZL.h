...
* Revision:	 														 		   *
*******************************************************************************/
#ifndef _USER_STACKER_TRUCK_PROC_KELI_H_
#define _USER_STACKER_TRUCK_PROC_KELI_H_
...
#define	Hand_SWI		             	SWI1_R
#define	HandleUp_SWI						  SWI3_R
#define HandleDown_SWI            SWI5_R
#define HeightLimit_SWI					  SWI4_R
#define	SnailRequest						  SWI6_R
#define	LIFTUP_SWI								SWI7_R
#define	LIFTDOWN_SWI							SWI8_R


#define Brake1_SWI              DRIVER2
#define Brake2_SWI              DRIVER3
#define DownBeep_SWI            DRIVER4
#define SpeedLimit1_SWI				  DRIVER5_R
#define	LIFTDOWNEN_SWI					DRIVER9_R
#define DianCiRelease_SWI				DRIVER10_R


#define	MOVE_THROTTLE			AI_B_AI1_R
#define	STREE_THROTTLE		AI_B_AI3_R
#define	TILE_THROTTLE			AI_B_AI2_R
...
#define	STEP_FACTOR					(5.0*256)/256
