...
#define	QIANYI_VALVE			DRIVER4
#define	HOUYI_VALVE				DRIVER5
#define ZUOYI_VALVE				DRIVER6
#define	HOUYANG_VALVE			DRIVER7
#define YOUYI_VALVE				DRIVER9
#define QIANQIN_VALVE			DRIVER10
...
#define LR_MOVE_THROTTLE	AI_B_AI2_R      //左右移调速
