...
#define LIFTDOWN_DO				DRIVER4

#define	LIFTDOWN_VALVE			PropDriverCh0			/*PropPump*/  //DRIVER 11 0 DRIVER 12 1

#define	HEIGHT300_SPEEDLIMIT_SWI	SWI1_R
#define	HEIGHT1800_LIMT_SWI					SWI2_R
#define	STEER_SAFE_LOCK						SWI3_R  
#define	FENCE1_SWI						  	SWI4_R
#define	FENCE2_SWI								SWI5_R
#define LIFT_LIMT_SWI							SWI7_R
#define PeDALS_SWI								SWI8_R
