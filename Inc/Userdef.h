...
/* 山东博俊 2.0T平衡重*/
#define USER_SDBOJUN_20TPHZ_MOVE					138
#define USER_SDBOJUN_20TPHZ_SMOVE					139
#define USER_SDBOJUN_20TPHZ_LIFT					140

/* 韩国 京畿道*/
#define USER_HANGUO_JINJIDAO_DGC					141

/* 杭叉 高机*/
#define USER_HANGCHA_GAOJI								142

/*韩国 京畿道 剪叉车 LIFT*/
#define USER_HANGUO_JINJIDAO_JDC						143

/*韩国 京畿道 堆高车*/
#define USER_HANGUO_JINJIDAO_DGC2						144

/*韩国 京畿道 小型代步车*/
#define USER_HANGUO_JINJIDAO_DBC						145
/***************************************** USER_TYPE *****************************************/

#define USER_TYPE							USER_GANGLI_PHZ15T_MOVE
...
#define	DRIVER_TYPE		_2425_HB4_GD32
#define CAN_Baudrate 	CAN_BAUD_RATE_125K   //CAN_BAUD_RATE_250K
#define CANOPEN_NODEID	0x2C
#define SOFTVERSION_LOGIC   0x01
...
#define HANHGCHA_APP_PARA
#define BATERRY_VOLTAGE_CONFIG_IN_PARA       //行走记电量可配置
#define	DRIVER_TYPE		_2425_HB4_GD32
#define CAN_Baudrate CAN_BAUD_RATE_125K
#define CAN_NoteID	0x2C
...
#define HANHGCHA_APP_PARA
#define HANGCHA_DGC_SPEC_IO_TYPE				//杭叉 特殊版 平衡重式堆高车需求
#define BATERRY_VOLTAGE_CONFIG_IN_PARA       //行走记电量可配置
#define	DRIVER_TYPE		_2425_HB4_GD32
#define CAN_Baudrate CAN_BAUD_RATE_125K
#define CAN_NoteID	0x2C
...
#define	DRIVER_TYPE		_2425_HB4_GD32
#define CAN_Baudrate 	CAN_BAUD_RATE_250K         //CAN_BAUD_RATE_125K
#define CANOPEN_NODEID	0x2C
#define	PCU_TYPE			PCU_TYPE_NONE  
#define NOID260				0
#endif
/* 山东博俊 2.0T平衡重*/
#if (USER_TYPE == USER_SDBOJUN_20TPHZ_SMOVE)
#define	DRIVER_TYPE		_2425_HB4_GD32
#define CAN_Baudrate 	CAN_BAUD_RATE_250K        //CAN_BAUD_RATE_125K
#define CANOPEN_NODEID	0x2D
#define	PCU_TYPE			PCU_TYPE_NONE  
#define NOID260				1
#endif
/* 山东博俊 2.0T平衡重*/
...
#define	DRIVER_TYPE		_2425_HB4_GD32
#define CAN_Baudrate 	CAN_BAUD_RATE_250K
#define CANOPEN_NODEID	0x23
#define	PCU_TYPE			PCU_TYPE_NONE  
#define JINJIDAO_BATTERTYPE 
#endif

/* 韩国 京畿道 DGC2*/
#if (USER_TYPE == USER_HANGUO_JINJIDAO_DGC2)
#undef USER_TYPE
#define USER_TYPE		USER_HANGUO_JINJIDAO_DGC
#define	DRIVER_TYPE		_2425_HB4_GD32
#define CAN_Baudrate 	CAN_BAUD_RATE_250K
#define CANOPEN_NODEID	0x23
#define	PCU_TYPE			PCU_TYPE_NONE  
#define JINJIDAO_BATTERTYPE 
#define JINJIDAO_DGC_IO_TYPE
#endif

/* 韩国 京畿道 JDC*/
#if (USER_TYPE == USER_HANGUO_JINJIDAO_JDC)
#define	DRIVER_TYPE		_2425_HB4_GD32
#define CAN_Baudrate 	CAN_BAUD_RATE_250K
#define CANOPEN_NODEID	0x24
#define	PCU_TYPE			PCU_TYPE_NONE  
#define JINJIDAO_BATTERTYPE 
#endif
