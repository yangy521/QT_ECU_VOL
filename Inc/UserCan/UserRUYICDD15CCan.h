#ifndef _USER_CAN_RUYICDD15C_CAN_ECU_
#define _USER_CAN_RUYICDD15C_CAN_ECU_
#include "stdint.h"
...
typedef union
{
	...
	struct
	{
		uint8_t u8MoveState;//前进0，后退1，直立4，刹车2，回中 8
