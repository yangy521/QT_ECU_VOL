#ifndef _USER_CAN_SANZHILIU_CAN_ECU_
#define _USER_CAN_SANZHILIU_CAN_ECU_
#include "stdint.h"
...
typedef union
{
	...
	struct
	{
		uint8_t	u8FlagParameter;
		
		uint8_t u8GPA1ValueLow;
		uint8_t u8GPA1ValueHigh;
    uint8_t u8GPA2ValueLow;
		uint8_t u8GPA2ValueHigh;		
		uint8_t u8GPA3ValueLow;
		uint8_t u8GPA3ValueHigh;
