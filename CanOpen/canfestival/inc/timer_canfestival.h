...
//void Canopen_int(void);
void Canopen_int(UNS8 nodeId);

typedef void (*CanOpenSendCbt)(UNS16, UNS8 *u8Data);

extern UNS8 u8CanOpenSendReg(UNS32 u32CanId, CanOpenSendCbt CallBack);		/*1 Success, 0 Fail*/
